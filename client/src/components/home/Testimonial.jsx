...
<>
  <div id='testimonials' className='flex flex-col item-center my-10 scroll-mt-12'>
      
              <div className="flex items-center gap-2 mx-auto w-fit text-sm text-green-800 bg-green-400/10 rounded-full px-6 py-1.5">
            <BookUserIcon className='size-4.5 stroke-green-600'/>
            <span>Testimonials</span>
        </div>

          <Title title="Don't just take our words" description="Hear what our users say about us. We're always looking for ways to improve . If you have positive experience wit us, leave a review."/>

...
return (
  <div className='relative'>
    <button
      ...
      className='flex items-center gap-2 text-sm text-purple-600 bg-linear-to-br from-purple-50 to-purple-100 ring-purple-300 hover:ring transition-all px-3 py-2 rounded-lg'
    >
      <Palette size={16} />
